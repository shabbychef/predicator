...
#define One_Two_Diff(b, a1, a0, x2, x1, x0) \
  Two_Diff(b, a0, _i, x0); \
  Two_Diff(_i, a1, x2, x1);

#define Two_Absolute(a1, a0, x1, x0) \
  if (a1 >= 0) {x1 = a1; x0 = a0}; \
  else {x1 = -a1; x0 = -a1}

#define Two_UMinus(a1, a0, x1, x0) \
  x1 = -a1; x0 = -a0
...
int shrink_expansion(REAL b, int elen, REAL *e, REAL *h);
int fast_expansion_diff_zeroelim(int elen, REAL *e, int flen, REAL *f, REAL *h);
int mult_expansion_zeroelim(int elen, REAL *e, int blen, REAL *b, REAL *h);
int expansion_double(int elen, REAL *e, REAL *h);
int expansion_absolute(int elen, REAL *e, REAL *h);
int expansion_uminus(int elen, REAL *e, REAL *h);
